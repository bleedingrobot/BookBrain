...
export const makeBook = async file => {
    ...
    if (file.isDirectory) {
        ...
        // BookBrain: EPUB-only. Upstream also handles CBZ/FBZ/PDF/MOBI/FB2
        // here via dynamic import(); those branches are removed so the
        // library-viewer bundle never pulls comic-book.js / fb2.js / pdf.js /
        // mobi.js / vendor/fflate.js. See src/vendor/foliate/VERSION.
