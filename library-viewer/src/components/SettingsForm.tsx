  ...
  return (
    <div className="mx-auto mt-16 max-w-md p-6">
      ...
      <p className="mt-2 text-sm text-neutral-500">
        This runs entirely in your browser — nothing is sent anywhere but Google. Both values
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          if (googleClientId.trim() && libraryFolderId.trim()) {
            onSave({ googleClientId: googleClientId.trim(), libraryFolderId: libraryFolderId.trim() })
          }
        }}
      >
